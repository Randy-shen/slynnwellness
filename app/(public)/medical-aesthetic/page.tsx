...
export const metadata: Metadata = {
  ...
  description:
    'Transform your appearance with expert injectable treatments at Slynn Wellness. Botox, Dysport, dermal fillers, Sculptra, and Kybella in Pasadena, CA.',
}

export default async function MedicalAestheticPage() {
  let services = await getServices('medical-aesthetic').catch(() =>
