...
export const metadata: Metadata = {
  title: 'Restylane Dermal Fillers in Pasadena, CA',
  description:
    'Restylane hyaluronic acid dermal fillers at Slynn Wellness in Pasadena, CA. Lip, cheek, jawline, under-eye, and tear trough filler treatments. Serving Pasadena, Altadena, San Marino, Arcadia, Glendale, and the greater Los Angeles area.',
  keywords: [
    // Brand + city
    'Restylane Pasadena',
    'best Restylane Pasadena',
    'Restylane near me',
    'Restylane filler Pasadena',
    'Restylane medical spa Pasadena',
    'Restylane injector Pasadena',
    'Restylane RN Pasadena',
    // Product line
    'Restylane Kysse Pasadena',
    'Restylane Lyft Pasadena',
    'Restylane Contour',
    'Restylane Defyne',
    'Restylane Refyne',
    'Restylane-L',
    ...
    'Restylane Eyelight',
    // Pricing intent
    'Restylane cost Pasadena',
    'Restylane price Pasadena',
    'Restylane per syringe',
    'dermal filler cost Pasadena',
    // Generic search terms
    'dermal fillers Pasadena',
    'hyaluronic acid filler Pasadena',
    'HA filler Pasadena',
    'best dermal filler Pasadena',
    'natural dermal filler Pasadena',
    // Treatment areas — high-volume keywords
    'lip filler Pasadena',
    'lip injection Pasadena',
    ...
    'Galderma Restylane',
    // Nearby cities
    'dermal filler Altadena',
    'lip filler South Pasadena',
    'lip filler San Marino',
    'lip filler Arcadia',
    'lip filler Sierra Madre',
    'lip filler Monrovia',
    'lip filler Temple City',
    'lip filler San Gabriel',
    'lip filler Alhambra',
    'lip filler La Cañada',
    'lip filler La Cañada Flintridge',
    'lip filler La Canada',
    'lip filler La Canada Flintridge',
    'lip filler Flintridge',
    'lip filler Glendale',
    'lip filler Burbank',
    'lip filler Eagle Rock',
    'lip filler Highland Park',
    'dermal filler San Gabriel Valley',
    'dermal filler Los Angeles',
    // Brand
