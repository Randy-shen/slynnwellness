...
export const metadata: Metadata = {
  title: 'GLP-1 Medical Weight Loss in Pasadena, CA',
  description:
    'Medical weight loss with FDA-cleared GLP-1 medications (Semaglutide and Tirzepatide) at Slynn Wellness in Pasadena, CA — physician-supervised, personalized programs. Serving Pasadena, Altadena, San Marino, Arcadia, Glendale, and the greater Los Angeles area.',
  keywords: [
    // Core service
    'medical weight loss Pasadena',
    'weight loss clinic Pasadena',
    'weight loss program Pasadena',
    'best weight loss Pasadena',
    'weight loss near me',
    'weight loss medical spa Pasadena',
    'weight loss doctor Pasadena',
    'physician weight loss Pasadena',
    'concierge weight loss Pasadena',
    // GLP-1 family
    'GLP-1 Pasadena',
    'GLP-1 weight loss Pasadena',
    'GLP-1 medication Pasadena',
    'GLP-1 injection Pasadena',
    'GLP-1 prescription Pasadena',
    'GLP-1 receptor agonist',
    // Semaglutide
    'Semaglutide Pasadena',
    'Semaglutide weight loss Pasadena',
    'Semaglutide injection Pasadena',
    'Semaglutide prescription Pasadena',
    'Semaglutide cost Pasadena',
    'compounded Semaglutide',
    'Semaglutide clinic Pasadena',
    // Tirzepatide
    'Tirzepatide Pasadena',
    'Tirzepatide weight loss Pasadena',
    'Tirzepatide injection Pasadena',
    'Tirzepatide prescription Pasadena',
    'Tirzepatide cost Pasadena',
    'compounded Tirzepatide',
    'Tirzepatide clinic Pasadena',
    ...
    'Saxenda Pasadena',
    'Liraglutide Pasadena',
    // Pricing
    'medical weight loss cost Pasadena',
    'GLP-1 cost Pasadena',
    'Semaglutide cost monthly',
    'Tirzepatide cost monthly',
    'weight loss program cost',
    'weight loss injection price',
    // Use cases / patient intent
    'weight loss injection Pasadena',
    'weight loss shot Pasadena',
    'lose weight fast Pasadena',
    'sustainable weight loss',
    'PCOS weight loss',
    'menopause weight loss Pasadena',
    ...
    'physician weight management',
    'telehealth weight loss',
    // Nearby cities
    'medical weight loss Altadena',
    'medical weight loss South Pasadena',
    'medical weight loss San Marino',
    'medical weight loss Arcadia',
    'medical weight loss Sierra Madre',
    'medical weight loss Monrovia',
    'medical weight loss Temple City',
    'medical weight loss San Gabriel',
    'medical weight loss Alhambra',
    'medical weight loss La Cañada',
    'medical weight loss La Cañada Flintridge',
    'medical weight loss La Canada',
    'medical weight loss Flintridge',
    'medical weight loss Glendale',
    'medical weight loss Burbank',
    'medical weight loss Eagle Rock',
    'medical weight loss Highland Park',
    'medical weight loss San Gabriel Valley',
