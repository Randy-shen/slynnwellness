...
export const metadata: Metadata = {
  title: 'IV Vitamin Therapy & Drips in Pasadena, CA',
  description:
    'Customized IV vitamin drips at Slynn Wellness in Pasadena, CA. Energy, hydration, immunity, recovery, beauty, and Myers cocktail IVs delivered by licensed RNs. Serving Pasadena, Altadena, San Marino, Arcadia, Glendale, and the greater Los Angeles area.',
  keywords: [
    // Brand + city
    'IV therapy Pasadena',
    'IV drip Pasadena',
    'IV vitamin therapy Pasadena',
    'best IV therapy Pasadena',
    'IV therapy near me',
    'IV drip near me Pasadena',
    'IV therapy medical spa Pasadena',
    'IV therapy clinic Pasadena',
    'mobile IV therapy Pasadena',
    'in-office IV drip Pasadena',
    // Pricing
    'IV therapy cost Pasadena',
    'IV drip price Pasadena',
    'IV vitamin therapy cost',
    'IV therapy package Pasadena',
    'monthly IV membership',
    // Popular drip names
    'Myers cocktail Pasadena',
    'Myers IV drip Pasadena',
    'immunity drip Pasadena',
    'immune boost IV Pasadena',
    'hydration drip Pasadena',
    'energy IV Pasadena',
    'B12 injection Pasadena',
    'B-complex IV Pasadena',
    'vitamin C IV Pasadena',
    'high-dose vitamin C IV',
    'glutathione IV Pasadena',
    'glutathione push Pasadena',
    'beauty IV Pasadena',
    'beauty drip Pasadena',
    'glow IV Pasadena',
    'recovery IV Pasadena',
    'athletic recovery drip',
    'post-workout IV',
    'hangover IV Pasadena',
    'hangover cure drip',
    'jet lag IV',
    'travel recovery IV',
    'wellness drip Pasadena',
    'detox IV Pasadena',
    'anti-aging IV',
    'libido IV',
    ...
    'IV before wedding',
    'IV before event',
    'pre-event IV Pasadena',
    'IV for athletes',
    'IV for hangover',
    'IV for jet lag',
    // Generic terms
    'vitamin infusion Pasadena',
    'nutrient IV Pasadena',
    'mineral IV Pasadena',
    ...
    'IV therapy by RN',
    'medically supervised IV',
    // Nearby cities
    'IV therapy Altadena',
    'IV therapy South Pasadena',
    'IV therapy San Marino',
    'IV therapy Arcadia',
    'IV therapy Sierra Madre',
    'IV therapy Monrovia',
    'IV therapy Temple City',
    'IV therapy San Gabriel',
    'IV therapy Alhambra',
    'IV therapy La Cañada',
    'IV therapy La Cañada Flintridge',
    'IV therapy La Canada',
    'IV therapy Flintridge',
    'IV therapy Glendale',
    'IV therapy Burbank',
    'IV therapy Eagle Rock',
    'IV therapy Highland Park',
    'IV therapy San Gabriel Valley',
