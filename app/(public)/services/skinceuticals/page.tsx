...
export const metadata: Metadata = {
  title: 'SkinCeuticals Advanced Medical Facial in Pasadena, CA',
  description:
    'SkinCeuticals Advanced Facial at Slynn Wellness in Pasadena, CA. Medical-grade, science-backed skincare treatment for targeted correction, deep hydration, and a luminous, healthy glow. Serving Pasadena, Altadena, San Marino, Arcadia, Glendale, and the greater Los Angeles area.',
  keywords: [
    // Brand + city
    'SkinCeuticals facial Pasadena',
    'SkinCeuticals Advanced Facial Pasadena',
    'best SkinCeuticals facial Pasadena',
    'SkinCeuticals near me',
    'SkinCeuticals medical spa Pasadena',
    'SkinCeuticals authorized provider',
    'SkinCeuticals professional treatment',
    // Pricing
    'SkinCeuticals facial cost Pasadena',
    'SkinCeuticals facial price',
    'medical facial cost Pasadena',
    // Generic / category
    'medical facial Pasadena',
    'medical-grade facial Pasadena',
    'science-backed facial Pasadena',
    'professional facial Pasadena',
    'clinical facial Pasadena',
    'corrective facial Pasadena',
    'best facial Pasadena',
    'top rated facial Pasadena',
    'luxury facial Pasadena',
    // Treatment specifics
    'Vitamin C facial Pasadena',
    'CE Ferulic facial',
    'antioxidant facial Pasadena',
    'brightening facial Pasadena',
    'hydrating facial Pasadena',
    'glow facial Pasadena',
    'red carpet facial',
    'event facial Pasadena',
    'pre-event facial',
    'wedding facial Pasadena',
    'bridal facial Pasadena',
    'monthly facial Pasadena',
    // Skin concerns
    'facial for hyperpigmentation Pasadena',
    'facial for dark spots',
    'facial for melasma',
    'facial for sun damage',
    'facial for dullness',
    ...
    'facial for skin tone',
    // Demographics
    'facial for men Pasadena',
    'teen facial',
    'first facial Pasadena',
    'facial gift card Pasadena',
    // Nearby cities
    'medical facial Altadena',
    'medical facial South Pasadena',
    'medical facial San Marino',
    'medical facial Arcadia',
    'medical facial Sierra Madre',
    'medical facial Monrovia',
    'medical facial Temple City',
    'medical facial San Gabriel',
    'medical facial Alhambra',
    'medical facial La Cañada',
    'medical facial La Cañada Flintridge',
    'medical facial La Canada',
    'medical facial Flintridge',
    'medical facial Glendale',
    'medical facial Burbank',
    'medical facial Eagle Rock',
    'medical facial Highland Park',
    'medical facial San Gabriel Valley',
    'medical facial Los Angeles',
    // Brand
    'Slynn Wellness facial',
    'luxury medical spa Pasadena',
  ],
  alternates: { canonical: '/services/skinceuticals' },
}
