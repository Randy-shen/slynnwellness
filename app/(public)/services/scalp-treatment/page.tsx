...
export const metadata: Metadata = {
  title: 'Scalp Treatment & Massage Therapy in Pasadena, CA',
  description:
    'Therapeutic scalp treatment at Slynn Wellness in Pasadena, CA. Expert scalp massage, exfoliation, and nourishing serums to relieve tension, restore scalp health, and support healthy hair. Serving Pasadena, Altadena, San Marino, Arcadia, Glendale, and the greater Los Angeles area.',
  keywords: [
    // Core
    'scalp treatment Pasadena',
    'scalp facial Pasadena',
    'scalp massage Pasadena',
    'scalp therapy Pasadena',
    'best scalp treatment Pasadena',
    'scalp treatment near me',
    'scalp treatment medical spa Pasadena',
    'scalp clinic Pasadena',
    'scalp spa Pasadena',
    // Variations
    'head spa Pasadena',
    'Korean head spa Pasadena',
    'Japanese head spa Pasadena',
    'scalp detox Pasadena',
    'scalp exfoliation Pasadena',
    'scalp cleanse Pasadena',
    'scalp peel Pasadena',
    'scalp relaxation Pasadena',
    'therapeutic scalp Pasadena',
    'scalp wellness Pasadena',
    // Pricing
    'scalp treatment cost Pasadena',
    'scalp massage price',
    'head spa price Pasadena',
    'monthly scalp treatment',
    // Concerns
    'dry scalp treatment Pasadena',
    'oily scalp treatment',
    'flaky scalp treatment',
    'dandruff treatment Pasadena',
    'itchy scalp treatment',
    'sensitive scalp treatment',
    'product buildup scalp',
    'scalp acne treatment',
    'sebum buildup scalp',
    'scalp circulation treatment',
    'scalp tension relief',
    'tension headache scalp massage',
    'scalp inflammation treatment',
    'scalp barrier repair',
    // Hair concerns
    'hair thinning treatment Pasadena',
    'hair loss support Pasadena',
    'hair growth treatment',
    'healthy hair scalp',
    'hair fall scalp treatment',
    'damaged hair treatment',
    'color-treated hair scalp',
    'chemically processed hair',
    'thick lustrous hair',
    'shiny hair treatment',
    // Wellness intent
    'stress relief Pasadena',
    'relaxation treatment Pasadena',
    'self-care Pasadena',
    'spa day Pasadena',
    'wellness treatment Pasadena',
    'mindfulness scalp massage',
    // Nearby cities
    'scalp treatment Altadena',
    'scalp treatment South Pasadena',
    'scalp treatment San Marino',
    'scalp treatment Arcadia',
    'scalp treatment Sierra Madre',
    'scalp treatment Monrovia',
    'scalp treatment Temple City',
    'scalp treatment San Gabriel',
    'scalp treatment Alhambra',
    'scalp treatment La Cañada',
    'scalp treatment La Cañada Flintridge',
    'scalp treatment La Canada',
    'scalp treatment Flintridge',
    'scalp treatment Glendale',
    'scalp treatment Burbank',
    'scalp treatment Eagle Rock',
    'scalp treatment Highland Park',
    'scalp treatment San Gabriel Valley',
    'scalp treatment Los Angeles',
    'head spa Los Angeles',
    // Brand
